...
if __name__ == '__main__':
    ...
    # sku_ids = '54695063302:2'  # 商品id
    # area = '1_72_55657'  # 区域id
    # asst = Assistant()  # 初始化
    ...
    asst = Assistant()      # 初始化
    asst.login_by_QRcode()  # 扫码登陆
    asst.add_item_to_cart(sku_ids='100012043978')  # 根据商品id添加购物车（可选）
    asst.submit_order_by_time(buy_time='2020-06-22 9:59:59.900', retry=3, interval=0.1)  # 定时提交订单
    # 3个参数：
